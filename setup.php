		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6">
					...
					' . ((!empty($errors)) ? '<div class="alert alert-danger alert-dismissible"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>' . implode('<br />', $errors) . '</div>' : '' ) . '
